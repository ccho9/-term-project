...
var renderGreen = true;
var renderMagenta = true;
...
window.onload = function init() {
    ...
    canvas.addEventListener("mousedown", function(event){
        ...
        if(color[0]>=125)
        if(color[1]>=125) console.log("yellow");
        else if(color[2]>=125) {
			console.log("magenta" + x + " " + y);
			renderMagenta = !renderMagenta;
		}
        else console.log("red");
        else if(color[1]>=125)
        if(color[2]>=125) console.log("cyan");
        else {
			console.log("green" + x + " " + y);
			renderGreen = !renderGreen;
		}
        else if(color[2]>=125) console.log("blue");
        else {
...
var render = function(){
   ...
   // render to texture
    ...
    gl.useProgram(program2);
    gl.vertexAttribPointer( vPosition2, 2, gl.FLOAT, false, 0, 32);
